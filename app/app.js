...
function statusbar() {
  return `<div class="statusbar statusbar-brand" aria-hidden="true">
    <div class="status-accent">
      <img src="${logoSrc('icon')}" alt="" class="status-hamsa">
    </div>
  </div>`;
}
...
function renderGuides() {
  ...
  root.innerHTML = `
    ...
    <section class="suggest-city-card">
      ...
      <a class="btn btn-secondary" href="#" data-suggest-city-open>Suggest a city</a>
    </section>
    <div class="suggest-modal" id="suggestCityModal" hidden>
